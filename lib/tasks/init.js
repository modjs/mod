...
exports.runGenerator = function(template, dest, data, done){
    ...
    var templateDir;
    var buildInGenerators = ['json', 'jquery', 'src', 'mocha', 'git', 'modfile', 'readme', 'plugin', 'licenses'];
    ...
    if(generator){
        ...
        var generators = [];
        generator.generators && Object.keys(generator.generators).forEach(function(template){
            if(ranGenerator[template]) return;
