...
exports.run = function (options, callback) {
    ...
    generators.forEach(function(val){
        ...
        parallelTasks.push( ncp.bind(this, dir, tempDest) );
    });
    ...
    exports.async.parallel(parallelTasks, function(err){
        ...
        tempDest = path.join(tempDest, "**/*");

        file.globSync(tempDest).forEach(function(inputFile){
