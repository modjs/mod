    ...
    HTMLParser(sourceString, {
        start: function(tag, attrs, unary) {
            ...
            if(loader = isScriptLoader(tag, attrs)){
                ...
                if( src = isLocalStylesheet(tag, attrs) || isLocalScript(tag, attrs) ){
                    ...
                    if(src in sequencedSrc){
                        ...
                        if(Array.isArray( sequencedSrc[src] )){
                            ...
                            var sequencedContents = sequencedSrc[src].map(function(src){
                                ...
                                sequencedDirname = path.dirname(src);
                                sequencedExtname = path.extname(src);
                            ...
                            var sequencedContentsDest = path.join(sequencedDirname, sequencedNames.join("+") + sequencedExtname);
