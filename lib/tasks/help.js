...
function usage(cmd) {
    ...
    console.log("Usage:");
    var usage = [' ','mod'.cyan, '<target>'.green , 'or'.grey , 'mod'.cyan, '<task>'.green,'[options]'.magenta];
...
function generateTasksDoc(){
    ...
    var hrefBasePath = 'https://github.com/modjs/mod/tree/master/doc/tasks/';
    var readmeData = {
        name : 'Tasks',
...
function generateApiDoc(){
    ...
    var hrefBasePath = 'https://github.com/modjs/mod/tree/master/doc/api/';
