...
function generateApiDoc(){
    ...
    sourceFiles.forEach(function(filepath){
        ...
        exports.log(fpath);
        exports.file.write(fpath, contents);
        readmeData.items.push({title: module.name, href: url.resolve(hrefBasePath, k + '.md'), summary: module.summary});
    });
...
function apiFactory(name, desc, ret, example, type){
    return {desc:desc, name:name, ret:ret, example: example, type: type}
}
