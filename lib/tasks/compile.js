...
exports.run = function (options, done) {
    ...
    // for async exec
    if('.js' === path.extname(options.source) && options.combine && loader == "requirejs"){
        ...
        return exports.compileRequireJS(options.source, outputFile, options, done);
    }
    ...
    exports.files.forEach(function(inputFile){
        ...
        // combine css import files
            ...
            contents = exports.precompile(inputFile, target, charset);
            var tempInputFile = file.suffix(inputFile, +new Date())
            file.write(tempInputFile, contents);
            contents = exports.runTask('combinecss', {source: tempInputFile, output: "pipe"});
        ...
        // compile and combine modules
            ...
            if(loader == "seajs"){
                contents =  exports.compileSeaJS(inputFile, outputFile, options);
            }else if(loader == "requirejs"){
                contents =  exports.compileRequireJS(inputFile, outputFile, options, done);
            }else{
...
exports.compileSeaJS = function(inputFile, outputFile, options){
...
exports.compileRequireJS = function (include, outputFile, options, callback) {
    ...
    var config = {
        ...
        wrap: options.wrap,
        optimize: 'uglify',
        include: include,  // Array params: ["foo", "bar"]
        out: outputFile,
        uglify: {
            toplevel: true,
            ascii_only: options.asciiOnly,
