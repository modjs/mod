 ...
 */
exports.stripDefine = function(mainModuleName, varModules, name, path, contents){
    var rdefineEnd = /\}\)[;^}\w]*$/;
    ...
    if ( new RegExp(".\/("+varModules+")\/").test( path ) ) {
        contents = contents
...
exports.compileRequireJS = function (inputFile, outputFile, options, callback) {
    ...
    if(options.stripDefine){
        ...
        config.onBuildWrite = exports.stripDefine.bind(this, options.mainModuleName, options.varModules);
