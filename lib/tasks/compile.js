...
exports.run = function (options, done) {
    ...
    if('.js' === path.extname(options.src) && options.combine && loader == "requirejs"){
        ...
        options.src = utils.arrayify(options.src);
    ...
    exports.files.forEach(function(inputFile){
        ...
        // combine css import files
            ...
            contents = exports.runTask('optimizecss', {src: tempInputFile, output: "pipe"});
...
exports.compileSeaJS = function(inputFile, outputFile, options){
    ...
    if(outputFile){
        ...
        exports.log(inputFile, '>', outputFile);
        exports.runTask('min', {src: outputFile, dest: outputFile});
    }
