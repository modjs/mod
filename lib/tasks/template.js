...
exports.helpers = {
    ...
    // content helper
    content: function content(src, isNotMinify, isNotCompile) {
        ...
        if (isNotMinify) {
            ...
            if(!isNotCompile && ['.html', '.css'].indexOf( path.extname(src) ) !== -1){
                var contents = exports.runTask('compile', {src: src, output: 'pipe'});
                src = file.writeTemp(src, contents);
            }

            return exports.runTask('min', {src: src, output: 'pipe'});
