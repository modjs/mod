...
exports.helpers = {
    ...
    // content helper
    content: function content(src, isNotMinify, isNotCombine, isNotCompile) {
        ...
        if (isNotMinify) {
            ...
            if(!isNotCompile && path.extname(src) === '.html'){
                var contents = exports.runTask('compile', {source: src, output: 'pipe'});
                src = file.writeTemp(src, contents);
            }
