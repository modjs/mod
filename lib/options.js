 ...
 * @return {object}
 */
exports.extend = function(taskLevelOptions, targetLevelOptions) {
    var args = [{}].concat(_.toArray(arguments));
    return _.extend.apply(null, args);
};

exports.getTaskLevelOptions = function(rc, taskName){
    return rc['tasks'][taskName]['options'] || {};
}

exports.getTargetLevelOptions = function(rc, taskName, targetName){
    return rc['tasks'][taskName][targetName]['options'] || {};
}
