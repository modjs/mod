 ...
 * @returns {Array}
 */
function copydir(/*String*/srcDir, /*String*/destDir, /*RegExp?*/regExpFilter, /*boolean?*/onlyCopyNew) {
 ...
 * @returns {boolean}
 */
function copyFile(/*String*/srcFileName, /*String*/destFileName, /*boolean?*/onlyCopyNew) {
    ...
    if ( exports.exists( topDir ) ) {
        ...
        for (i = 0; i < dirFileArray.length; i++) {
            ...
            if (stat.isFile()) {
                ...
                dirFiles = exports.getFilteredFileList(filePath, regExpFilters, makeUnixPaths);
...
exports.mkdirTemp = function(dirname, mode){
    var temp = path.join(config.TMP_DIR ,  'mod_temp_dir', dirname || +new Date());
