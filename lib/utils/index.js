 ...
 */
exports.findPackageJSON = function (p) {
    return file.find(p, 'package.json');
};
...
exports.getVersion = function () {
    var p = exports.findPackageJSON(__dirname);
    return exports.readJSON(p).version;
};
...
exports.loadPackageJSON = function (dir) {
    var filepath = path.resolve(dir, 'package.json');
    var json = exports.readJSON(filepath);
    try {
