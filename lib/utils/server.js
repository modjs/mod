...
/**
 * Convenience method for creating a Server object instance.
 *
 * @param {String} server_url
 * @api public
 */

var exports = module.exports = function (server_url) {
    return new Server(server_url);
};
...
Server = exports.Server = function (server_url) {

    var ins = this.instance = url.parse(server_url);
    ...
    logger.debug("URL",JSON.stringify(this.instance));
};

/**
 * Tests if a resource exists, creates it if not.
 *
 * @param {Function} callback
 * @api public
 */

Server.prototype.ensure = function (callback) {
    var that = this;
...
/**
 * Convenience HTTP client for querying a Server instance. Buffers and parses
...
Server.prototype.client = function (method, path, data, callback) {

    var pathname = this.instance.pathname || this.instance.path;
    ...
    // get porxy
    debugger;
    var proxy = utils.getHttpProxy( params.host );

    logger.debug("host", this.instance.hostname + ":" + this.instance.port);
    ...
    if ( proxy ) {
        ...
        logger.debug( "proxy", proxyUrl.hostname + ":" + proxyUrl.port );
...
Server.prototype.exists = function (id, callback) {
...
/**
 * Retrieve a document from a Server instance.
 *
 * @param {String} id
 * @param {Object} data
 * @param {Function} callback
...
Server.prototype.get = function (id, /*optional*/data, callback) {
...
/**
 * Saves a document to a Server instance.
 *
 * Options:
...
Server.prototype.save = function (id, doc, /*optional*/options, callback) {
    var that = this;
...
/**
 * Deletes a document from a Server instance.
 *
 * Options:
...
Server.prototype.delete = function (id, rev, /*optional*/options, callback) {
    var that = this;
