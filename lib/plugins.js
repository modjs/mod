        ...
        try{
            ...
            paths.some(function(modulePath){
                if(fs.existsSync(modulePath)){
                    logger.debug('plugin', taskName + ' installed at ' + modulePath);
...
exports.install = function(pluginsConfig, callback){
    ...
    if( _.isEmpty(pluginsConfig) ){
        ...
        console.log( loggerPrefix + ("Plugins configuration detected" ).underline );
    }
    ...
    _.each(pluginsConfig, function(pluginName, taskName){
        ...
        if(!exports.loadTask(taskName)) {
            ...
            logger.info('plugin', taskName.green + '(' + pluginName + ') ' + 'has been installed'.yellow);
        }else{
            logger.info('plugin', taskName.green + '(inline plugin)' + 'has been installed'.yellow)
        }
