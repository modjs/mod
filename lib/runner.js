...
exports.loadTask = function(taskName){
    ...
    /**
     * Desktop notifications API on Mac OS X
     * @method exports.notify
     * @example
     * exports.notify('Hello Mod.js')
     * })
     */

    task.notify = function (message) {
...
exports.run = function(cmd, cwd, done){
    ...
    plugins.install(pluginsConfig, function(){
        ...
        if (cmd && (task = exports.loadTask(cmd, rc))) {
            logger.needsEnd = true;
            console.log( loggerPrefix + ("Running task " + cmd.green ).underline );
            ...
            console.log( loggerPrefix + ("Running target " + cmd.green + ' "' + target + '"').underline );
